...
{% content-ref url="understanding-markets/" %}
...
{% content-ref url="walkthroughs/" %}
[walkthroughs](walkthroughs/)
{% endcontent-ref %}

{% content-ref url="payouts-and-settlement/" %}
[payouts-and-settlement](payouts-and-settlement/)
{% endcontent-ref %}

{% content-ref url="wallet-and-funds.md" %}
[wallet-and-funds.md](wallet-and-funds.md)
{% endcontent-ref %}
