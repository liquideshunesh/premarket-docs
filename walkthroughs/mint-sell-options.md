...
Go to Markets and open an active options market. Select the price band that matches your view on where the underlying asset will settle at expiry.
...
{% hint style="info" %}
After selling your oPRM tokens, you hold only PRM tokens. At expiry, if the band is out of the money, you withdraw your full collateral using the PRM token.
{% endhint %}
