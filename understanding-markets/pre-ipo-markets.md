...
Pre IPO markets use the same valuation band mechanic as Pre TGE markets. The only difference is the underlying asset is a company at IPO, not a token at TGE.

## How Bands Work

Each market offers a set of valuation bands. You pick the band that matches your view on where the company will list. Your payout depends on where the listing market capitalisation lands relative to your band at settlement.

> **Example:** A pre IPO market on a private company offers bands of $5B to $10B, $10B to $20B, and $20B to $50B. You believe the company will list above $10B. You buy the $10B to $20B band. If the company lists at $14B, your payout is proportional to how far into the range it lands. If it lists at $20B or above, you receive the maximum payout. If it lists below $10B, you receive nothing.

## Payout Logic

Pre IPO bands are directional spreads. Payout increases linearly as the listing market capitalisation moves in your favour within the range, and is capped at the maximum once it crosses the far strike in your direction.

| Scenario | Result |
| --- | --- |
| Listing value on wrong side of near strike | $0. Full loss. |
| Listing value within the band | Payout increases linearly toward the far strike |
